  ...
  theme: {
    extend: {
      borderRadius: {
        ...
        'mac-md': 'var(--mac-radius-md)',
        'mac-sm': 'var(--mac-radius-sm)',
        'mac-xs': 'var(--mac-radius-xs)',
        'mac-pill': 'var(--mac-radius-pill)',
      },
      colors: {
        ...
        macos: {
          window: 'var(--mac-window-bg)',
          sidebar: 'var(--mac-sidebar-bg)',
          content: 'var(--mac-content-bg)',
          toolbar: 'var(--mac-toolbar-bg)',
          grouped: 'var(--mac-grouped-bg)',
          accent: 'var(--mac-accent)',
          text: {
            primary: 'var(--mac-text-primary)',
            secondary: 'var(--mac-text-secondary)',
            tertiary: 'var(--mac-text-tertiary)',
          },
      ...
      fontFamily: {
        ...
        mac: ['-apple-system', 'BlinkMacSystemFont', '"SF Pro Text"', '"SF Pro Display"', '"Helvetica Neue"', 'Inter', '"Segoe UI"', 'Roboto', 'sans-serif'],
        'mac-mono': ['"SF Mono"', 'ui-monospace', 'SFMono-Regular', 'Menlo', 'Consolas', 'monospace'],
      },
      boxShadow: {
