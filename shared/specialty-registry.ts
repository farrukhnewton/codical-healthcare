...
export const SPECIALTY_MODULES: readonly SpecialtyModule[] = [
  ...
  },
  {
    ...
    description: "Complex transplant episodes, status codes, and service sequencing.",
    icon: "heart-pulse",
    color: "#8b5cf6",
  ...
  {
    id: "otp-mat",
    title: "OTP/MAT Bundle",
    shortTitle: "OTP/MAT Bundle",
    description: "Opioid treatment program and medication-assisted treatment bundles.",
    icon: "pill",
    color: "#14b8a6",
