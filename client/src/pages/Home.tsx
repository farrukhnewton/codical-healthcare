...
const TOOLS = [
  ...
  { href: "/payers", icon: Building2, label: "Payer Intelligence", desc: "Major USA Carriers", variant: "ocean" },
  { href: "/compliance", icon: Shield, label: "HIPAA Compliance", desc: "Audit trail (Admin)", variant: "sunrise" },
  { href: "/ncci", icon: Shield, label: "NCCI Checker", desc: "Edit validation", variant: "sunrise" },
  { href: "/guidelines", icon: BookOpen, label: "Knowledge Center", desc: "LCD/NCD/Guidelines", variant: "ocean" },
